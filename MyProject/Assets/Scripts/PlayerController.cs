...
public class PlayerController : MonoBehaviour
{
    ...
    [SerializeField] TextMeshProUGUI zombiesKilledCountText;
    [SerializeField] Button restartButton;
    
    float horizontalInput;
    float verticalInput;
    bool isDead;
    int numberOfZombiesKilledTemp = 0; //is going to be used for increasing difficulty
    int numberOfZombiesKilledGlobal = 0;
    float timer = 0;
    ...
    public int GetNumberOfZombiesKilledTemp()
    {
        return numberOfZombiesKilledTemp;
    }

    public int GetNumberOfZombiesKilledGlobal()
    {
        return numberOfZombiesKilledGlobal;
    }
    //setters
    public void IncreaseNumberOfZombiesKilledTemp()
    {
        numberOfZombiesKilledTemp++;
    }

    public void IncreaseNumberOfZombiesKilledGlobal()
    {
        numberOfZombiesKilledGlobal++;
    }

    public void SetNumberOfZombiesKilledTemp(int numberToSet)
    {
        numberOfZombiesKilledTemp = numberToSet;
    }
    ...
    void Update()
    {
        ...
        //display number of zombies killed
        zombiesKilledCountText.text = "Zombies Killed : " + numberOfZombiesKilledGlobal;

        //fire bullets from weapon, with the muzzle flash and sound
        if (Input.GetMouseButton(0) && !isDead && !isReloading())
        {
    ...
    void Move()
    {
        ...
        playerRb.AddForce(moveDirection * speedWalking * Time.deltaTime, ForceMode.Impulse);

        //Animation movements in all the directions
